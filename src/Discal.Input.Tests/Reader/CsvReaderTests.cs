...
namespace Discal.Input.Tests
{
  ...
  public class CsvReaderTests
  {
    ...
    public void ReadFromCsvFile_WithCorrectData_ExpectsFoundationModelInstances_WithCorrectValues()
    {
      ...
      IEnumerable<Foundation> foundations = reader.Read(CorrectTestFile);
    ...
    {
      IReader reader = new CsvReader();
      IEnumerable<Foundation> foundations = reader.Read(IncompleteTestFile);
    ...
    {
      IReader reader = new CsvReader();
      IEnumerable<Foundation> foundations = reader.Read(IncorrectTestFile);
